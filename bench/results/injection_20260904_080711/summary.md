...
| Qwen3-1.7B | eager | karvonen_add_generation | — | coeff 1.0 | — | — | — | next-token logprob max diff 0.137 (clean-prompt noise 0.191); greedy-8 equal 4/4 | 2/2 |
...
| Qwen3-1.7B | graphs | karvonen_add_generation | — | coeff 1.0 | — | — | — | next-token logprob max diff 0.137 (clean-prompt noise 0.191); greedy-8 equal 4/4 | 2/2 |
